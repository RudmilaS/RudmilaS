...
## 🧩 Skills — Puzzle Pieces

| 🟪 Python | 🟩 R | 🟨 Excel | 🟧 Physics |
|-----------|------|----------|------------|
| NumPy · pandas | Regression · Stats | Pivot tables · SUMIF | Numerical modeling |
...
I'm currently seeking a **4–16 month data analytics or solutions delivery internship** through UAlberta's Science Internship/Co-op Program.
...
`Python` `SymPy` `SciPy` `Matplotlib` `Numerical Methods`
